...
remove any memset(wall,0, ...) repeats before phase 3 initialization


Edit/remove all prior snippets in calls in phase 1, 2, and 3. 
...
change these to functions wall[Left, Right, Front] retrieves values from the external sensors, and places a value/bool true or false in relevant main.c code 
Calibrate to return boolean true 